...
水墨画风修仙文字游戏。330 个剧情节点，30 轮决策深度，6 条主线，79 种结局。
...
| 功能 | 说明 |
|------|------|
| 当前目标 | 每个章节显示短目标，降低迷路感 |
| 选择提示 | 选项下方显示属性倾向、风险和人脉影响 |
| 资源循环 | 灵石、历练、丹药、心魔、轮回点随路线变化 |
| 路线奖励 | 剑修、丹修、宗门、散修、古玉、商道各有成长反馈 |
| 结算评分 | 结局后按属性、资源、声望、法宝和心魔给出评分原因 |
| 快速轮回 | 浏览器版可一键带着轮回积累重开 |
| 命运图谱 | 浏览器版展示六大路线节点、已访问节点和成就线索 |
| 奇遇反馈 | 选择后展示属性、资源、声望、羁绊和法宝变化 |
...
├── playability.py     # 玩法增强/资源/轮回/命运图谱规则
