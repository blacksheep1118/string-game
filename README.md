...
一款以选择为核心的中文文字修仙游戏。当前剧情数据包含 **330 个节点、79 个结局**：每次选择会改变属性、资源、声望、羁绊和收集品，低属性判定还会把你带入另一条命运分支。
...
- Web 端支持响应式布局、键盘操作、PWA、主题/字号/音效设置；桌面端提供炼丹互动窗口，并保留可扩展的战斗组件。
...
├── playability.py           # 奖励、奇遇、路线、评分和命运图谱规则
